...
public class ProductService(IRepository<Models.Product> productRepo, IEntityService<Models.Product> entityService, IEntityService<Models.Category> categoryEntityService, IMapper mapper) :
